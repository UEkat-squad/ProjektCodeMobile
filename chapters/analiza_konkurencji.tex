...
Przed zabraniem się za projektowanie pobraliśmy parę aplikacji konkurencji oraz sprawdziliśmy ich opinie. Informacje które zebraliśmy są skompilowane poniżej.
...
\end{itemize}
\section{Wnioski}
Aplikacje naszej konkurencji są skomplikowane, drogie albo wykorzystują system subskrypcji. Nasza aplikacja z drugiej strony powinna być zarówno prosta jak i darmowe. Monetyzowanie naszej aplikacji będzie opierało się wyłącznie na dobrowolnych dotacjach ponieważ uważamy że każdy powinien mieć dostęp do dobrych pozbawionych reklam narzędzi do programowanie.